...
public class StringUtil implements Serializable {
    ...
    //Kiểm tra xem có phải là mã NVCP không
    public static boolean isExpenseCode(String input) {
        String pattern = "(\\.?\\d)+";
        return input.matches(pattern);
    }
    ////////////////////////////////////////////////////////////////////////

    //Convert giá trị null hoặc trống
    public static String evl(String input, String value) {
        return input == null || input.isEmpty() ? value : input;
    }
    ////////////////////////////////////////////////////////////////////////

    //Convert giá trị null
    public static String nvl(String input, String value) {
        return input == null ? value : input;
    }
    ////////////////////////////////////////////////////////////////////////

    //Convert null thành trống
    ...
    public static boolean isEmailString(String input) {
    ...
    //Convert chuỗi thành tiếng Việt không dấu
